...
class sentistrength:
    def __init__(self, config=dict()):
        self.negasi = [line.replace('\n','') for line in open("sentimen_ind/negativeword.txt").read().splitlines()]
        self.tanya = [line.replace('\n','') for line in open("sentimen_ind/questionword.txt").read().splitlines()]
        #create sentiment words dictionary
        self.sentiwords_txt = [line.replace('\n','').split(":") for line in open("sentimen_ind/sentiwords_id.txt").read().splitlines()]
    ...
    def main(self,sentence):
        ...
        #return {"kelas":sentence_result,"tweet_text":". ".join(self.sentences_text)}
